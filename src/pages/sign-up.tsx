    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex items-end h-32 bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt="Night"
            src="https://images.unsplash.com/photo-1610312278520-bcc893a3ff1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2047&q=80"
            ...
            <form action="#" className="grid grid-cols-6 gap-6 mt-8">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="FirstName"
                  name="first_name"
                  className="w-full mt-1 text-sm text-gray-700 bg-white border-gray-200 rounded-md "
                />
              </div>
              ...
              <div className="col-span-6">
                <label htmlFor="MarketingAccept" className="flex gap-4">
                  <input
                    ...
                    className="w-5 h-5 bg-white border-gray-200 rounded-md "
                  />
